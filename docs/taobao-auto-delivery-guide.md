...
| 卡种名称 | rate_limit_group | Token 前缀 | 额度 |
|---------|-----------------|------------|------|
| 9.9元体验版 | （无，总量控制） | sk-trial- | 总量100次 |
| 性价比月卡 | basic | sk-glm-v1- / sk-glm- | 500次/5小时 |
| 基础版月卡 | standard | sk-glm-v1- | 1000次/5小时 |
| 升级版月卡 | premium | sk-glm-v1- | 1500次/5小时 |
| 黄金月卡 | pro | sk-gold- | 2000次/5小时 |
| 大胃王月卡 | weekly | sk-big- | 40000次/周 |
...
🔍 查询额度：https://atmapi.aitomoney.online/token-info
...
Token **首次使用后 30 天过期**。月卡类额度每 5 小时自动重置，9.9 元体验版为一次性额度（总量100次）。
